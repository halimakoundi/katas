...
namespace PayslipKata.Test
{
    public class PrintSalarySlipFeature
    {
        ...
        [TestCase("AnotherEmployeeId", "Jane Doe",
                    40000,
                    3333.33,
                    319.40,
                    916.67,
                    2416.67,
                    216.67)]
        public void Print_Payslip_For_A_Given_Employee(string id, string name,
                                                        decimal annualSalary,
                                                        decimal grossSalary,
                                                        decimal nationalInsuranceContributions,
                                                        decimal taxFreeAllowance,
                                                        decimal taxableIncome,
                                                        decimal taxPayable)
        {
            var employee = new Employee(id, name, annualSalary);
            var payslip = new Payslip(employee, grossSalary,
